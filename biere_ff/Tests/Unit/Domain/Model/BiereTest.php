 ...
 */
class BiereTest extends UnitTestCase
{
    /**
     * @var \Biere\BiereFf\Domain\Model\Biere|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \Biere\BiereFf\Domain\Model\Biere::class,
            ['dummy']
        );
    }
     ...
     * @test
     */
    public function getDegreeReturnsInitialValueForInt(): void
    {
        self::assertSame(
            0,
     ...
     * @test
     */
    public function setDegreeForIntSetsDegree(): void
    {
        $this->subject->setDegree(12);

        self::assertEquals(12, $this->subject->_get('degree'));
    }
