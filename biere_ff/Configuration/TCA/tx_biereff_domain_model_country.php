...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:biere_ff/Resources/Private/Language/locallang_db.xlf:tx_biereff_domain_model_country',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => '',
        'iconfile' => 'EXT:biere_ff/Resources/Public/Icons/tx_biereff_domain_model_country.gif'
    ],
    'types' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_biereff_domain_model_country}.{#pid}=###CURRENT_PID### AND {#tx_biereff_domain_model_country}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
