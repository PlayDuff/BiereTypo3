...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:biere_ff/Resources/Private/Language/locallang_db.xlf:tx_biereff_domain_model_review',
        'label' => 'content',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_biereff_domain_model_review}.{#pid}=###CURRENT_PID### AND {#tx_biereff_domain_model_review}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
